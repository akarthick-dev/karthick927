...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function createParticle() {
        ...
        const colors = ['rgba(220,38,38,0.3)', 'rgba(239,68,68,0.25)', 'rgba(185,28,28,0.2)', 'rgba(248,113,113,0.2)'];
    ...
    document.querySelectorAll('.achievement-card, .project-card, .contact-card').forEach(card => {
        card.addEventListener('mousemove', (e) => {
            ...
            card.style.background = `radial-gradient(600px circle at ${x}px ${y}px, rgba(220,38,38,0.03), transparent 40%), rgba(255,255,255,0.6)`;
        });
    ...
    console.log(
        ...
        'font-size: 24px; font-weight: bold; background: linear-gradient(135deg, #dc2626, #ef4444); -webkit-background-clip: text; -webkit-text-fill-color: transparent;'
    );
    console.log(
